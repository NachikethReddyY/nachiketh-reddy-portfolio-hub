...
import { ExternalLink, Award, Calendar, Search, Eye } from 'lucide-react';
...
const CertificatesPage = () => {
  ...
  const statuses = ['all', ...new Set(certificates.map(cert => cert.status))];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {loading ? (
            <div className="text-center py-12">
              <p className="text-gray-500 dark:text-gray-400 text-lg">Loading certificates...</p>
            </div>
          ) : (
