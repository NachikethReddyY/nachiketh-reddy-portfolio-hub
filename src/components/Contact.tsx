      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card className="bg-white border-0 shadow-md h-fit">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center p-3 rounded-lg">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Open to remote work</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        className="border-gray-300 focus:border-[#5271FF] focus:ring-[#5271FF]"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      rows={6}
                      className="border-gray-300 focus:border-[#5271FF] focus:ring-[#5271FF] resize-none"
                    />
                  </div>
